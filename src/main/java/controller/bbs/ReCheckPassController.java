...
public class ReCheckPassController extends HttpServlet {

	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		// 타이틀이름 리퀘스트영역 저장
		req.setAttribute("title", "KOSMOReCheckPass");
		// 이동
		req.getRequestDispatcher("/bbs/ReCheckPass.jsp").forward(req, resp);
	}
